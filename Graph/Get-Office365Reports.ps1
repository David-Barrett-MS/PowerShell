...
param (
	...
	[Parameter(Mandatory=$False,HelpMessage="The date for which to retrieve reports.  Must be in format YYY-MM-DD.  Cannot be used with RequestedPeriods.")]
    [ValidateNotNullOrEmpty()]
	$Date
)
...
$availableReports = @(
    ...
    "getEmailAppUsageAppsUserCounts", # period only
    "getEmailAppUsageUserCounts", # period only
    "getEmailAppUsageVersionsUserCounts", # period only
    "getOffice365ActivationsUserDetail", # no parameters
    "getOffice365ActivationCounts", # no parameters
    "getOffice365ActivationsUserCounts", # no parameters
    "getOffice365ActiveUserDetail",
    "getOffice365ActiveUserCounts", # period only
    "getOffice365ServicesUserCounts", # period only
    "getOffice365GroupsActivityDetail",
    "getOffice365GroupsActivityCounts", # period only
    "getOffice365GroupsActivityGroupCounts", # period only
    "getOffice365GroupsActivityStorage", # period only
    "getOffice365GroupsActivityFileCounts" # period only
)
